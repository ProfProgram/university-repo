...
public class MotherLink {
	...
	public MotherLink(Female female) {
		 ...
		 */
		this.lastInLine = new LinearNode<Female>(female);
	}
	...
	public String toString()
	{
		 ...
		 */
		while (tabCount < this.size()) {
			results += current.getElement().toString() + " who is the dughter of...\n	";
			current = current.getNext();
			tabCount ++;
		}
		// for adding the final name with no daughter.
		current = current.getNext();
